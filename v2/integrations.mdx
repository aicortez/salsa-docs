...
<CardGroup cols={3}>
  <Card icon="credit-card" title="Point of Sale (POS)" href="#pos-systems" arrow>
    Connect with major POS platforms for real-time sales and inventory sync.
  </Card>
  <Card icon="truck" title="Supply Chain" href="#supply-chain" arrow>
  ...
  <Card icon="building" title="Enterprise Systems" href="#enterprise" arrow>
...
<CardGroup cols={3}>
  <Card icon="code" title="REST API" href="/v2/api-reference#rest" arrow>
    Traditional REST endpoints for broad compatibility.
  </Card>
  <Card icon="code-branch" title="GraphQL API" href="/v2/api-reference#graphql" arrow>
    Flexible queries and real-time subscriptions.
  </Card>
  <Card icon="webhook" title="Webhooks" href="/v2/api-reference#webhooks" arrow>
