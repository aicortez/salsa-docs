...
<CardGroup cols={3}>
  <Card title="AI-Powered Forecasting" icon="microchip-ai" href="v2/advanced-usage#ai-powered-demand-forecasting">
    Machine learning predicts demand with 95% accuracy, reducing waste and optimizing production.
  </Card>
  <Card title="IoT Quality Monitoring" icon="chart-network" href="v2/advanced-usage#iot-sensor-integration">
    Real-time sensor integration monitors freshness, temperature, and quality automatically.
  </Card>
  <Card title="Advanced Integrations" icon="code-merge" href="/v2/integrations">
