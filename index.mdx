...
$$
T_{ECA,Q_n}\equiv\frac{200|P_{b,Q_{n-1}}|}{rP_{rated}} \quad 
$$

$$
T_{LCA,Q_n}\equiv\frac{200|P_{b,Q_{n}}|}{rP_{rated}}
$$
...
<CardGroup cols={3}>
  <Card title="AI-Powered Forecasting" icon="microchip-ai" href="/advanced-usage#ai-powered-demand-forecasting">
    Machine learning predicts demand with 95% accuracy, reducing waste and optimizing production.
  </Card>

  <Card title="IoT Quality Monitoring" icon="chart-network" href="/advanced-usage#iot-sensor-integration">
    Real-time sensor integration monitors freshness, temperature, and quality automatically.
  </Card>

  <Card title="Advanced Integrations" icon="code-merge" href="/integrations">
...
<CardGroup cols={2}>
  <Card title="Get Started with v2.0" icon="rocket-launch" href="/getting-started">
    New to Salsa as a Service? Start with v2.0 today.
  </Card>

  <Card title="Upgrade from v1.0" icon="chevrons-up" href="https://app.salsaasaservice.com/upgrade">
    Existing customer? Upgrade to v2.0 in minutes.
  </Card>

  <Card title="Explore Advanced Features" icon="book-open" href="/advanced-usage">
...
- Browse our [Getting Started Guide](/getting-started) for setup instructions
- Explore [Advanced Usage](/advanced-usage) for AI and IoT features
- Check our [API Reference](/api-reference) for developer documentation
- Visit [Integrations](/integrations) to connect your systems
- Contact our support team at [support@salsaasaservice.com](mailto:support@salsaasaservice.com)