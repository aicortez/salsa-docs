...
<CardGroup cols={3}>
  <Card icon="microchip-ai" href="advanced-usage#ai-powered-demand-forecasting" title="AI-Powered Forecasting">
    Machine learning predicts demand with 95% accuracy, reducing waste and optimizing production.
  </Card>
  <Card icon="chart-network" href="advanced-usage#iot-sensor-integration" title="IoT Quality Monitoring">
    Real-time sensor integration monitors freshness, temperature, and quality automatically.
  </Card>
  <Card icon="code-merge" href="integrations" title="Advanced Integrations">
...
<CardGroup cols={2}>
  <Card icon="rocket-launch" href="getting-started" title="Get Started with v2.0" arrow>
    New to Salsa as a Service? Start with v2.0 today.
  </Card>
  <Card icon="chevrons-up" href="https://app.salsaasaservice.com/upgrade" title="Upgrade from v1.0" arrow>
    Existing customer? Upgrade to v2.0 in minutes.
  </Card>
  <Card icon="book-open" href="advanced-usage" title="Explore Advanced Features" arrow>
    Learn about AI forecasting, IoT integration, and more.
  </Card>
  <Card icon="plug" href="integrations" title="View Integrations" arrow>
