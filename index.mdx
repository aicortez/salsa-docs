...
<CardGroup cols={3}>
  <Card icon="microchip-ai" href="v2/advanced-usage#ai-powered-demand-forecasting" title="AI-Powered Forecasting">
    Machine learning predicts demand with 95% accuracy, reducing waste and optimizing production.
  </Card>
  <Card icon="chart-network" href="v2/advanced-usage#iot-sensor-integration" title="IoT Quality Monitoring">
    Real-time sensor integration monitors freshness, temperature, and quality automatically.
  </Card>
  <Card icon="code-merge" href="/v2/integrations" title="Advanced Integrations">
...
<CardGroup cols={2}>
  <Card icon="rocket-launch" href="/v2/getting-started" title="Get Started with v2.0" arrow>
  ...
  <Card icon="book-open" href="/v2/advanced-usage" title="Explore Advanced Features" arrow>
    Learn about AI forecasting, IoT integration, and more.
  </Card>
  <Card icon="plug" href="/v2/integrations" title="View Integrations" arrow>
