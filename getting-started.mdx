...
<Card title="Advanced Usage" icon="chart-line" href="/advanced-usage" horizontal arrow>
  Deep dive into AI forecasting, IoT monitoring, and automation.
</Card>
<Card title="Integrations Guide" icon="plug" href="/integrations" horizontal arrow>
  Explore all 50+ available integrations.
</Card>
<Card title="API Documentation" icon="code" href="/api-reference" horizontal arrow>
